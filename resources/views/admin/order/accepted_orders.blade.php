            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">طلبات قيد حل</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-responsive table-striped">
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <form class="solvedForm{{$order->id}}" action="{{route('orders.solved',[$order->id])}}" method="POST">
                                        @csrf
                                        @method('put')
                                        <button type="button" onclick="confirmSolved({{$order->id}})" class="btn btn-primary mx-1">تم حل الطلب</button>
                                    </form>
                                </td>
                            </tr>
                            @endforeach
